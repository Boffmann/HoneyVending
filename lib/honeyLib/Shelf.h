...
class Shelf {
  ...
  public:
    ...
    /**
     * Get the number of shelfs
     * 
     * @return Number of shelfs
     */
    const uint8_t get_shelf_count(void);
  ...
  private:
     ...
     * @param door_number Door to open
     */
    void _open_door(const uint8_t door_number) const;

    /**
     * Closes all doors
     */
    void _close_doors(void) const;
